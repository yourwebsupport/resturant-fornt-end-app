...
export class AuthService implements OnDestroy {
  ...
  get currentUserValue(): UserType {
    console.log("currentUserValue->GET::AuthService ## "+this.currentUserSubject.value);
    return this.currentUserSubject.value;
  }

  set currentUserValue(user: UserType) {
    console.log("currentUserValue->SET::AuthService  ##  currentUserSubject.next(user) "+ this.currentUserSubject.next(user));
  ...
  constructor(
    ...
    console.log("currentUserValue::AuthService ## constructor ");
